...
\begin{figure}[t]
    \centering
    \resizebox{0.95\linewidth}{!}{% inlined TikZ: fig_dynamic_graph.tikz
...
\begin{figure}[t]
    \centering
    \subfloat[Graph encoder (last snapshot)]{\resizebox{0.85\columnwidth}{!}{% inlined TikZ: fig_encoder.tikz
...
\end{tikzpicture}
    ...
    \subfloat[Route encoder (vehicle intent)]{\resizebox{0.85\columnwidth}{!}{% inlined TikZ: fig_route_encoder.tikz
...
\end{tikzpicture}
    ...
    \subfloat[Router and Mixture-of-Experts]{\resizebox{0.85\columnwidth}{!}{% inlined TikZ: fig_router_moe.tikz
...
\matrix (experts) [row sep=0mm, column sep=6mm, right=16mm of router, below=8mm of router, ampersand replacement=\&] {
...
\begin{figure}[t]
    \centering
    \subfloat[Trip duration]{\includegraphics[width=0.48\linewidth]{porto_g_vs_porto_t_duration.png}}\hfill
    \subfloat[Trip distance]{\includegraphics[width=0.48\linewidth]{porto_g_vs_porto_t_distance.png}}
...
\begin{figure*}[t]
    \centering
    \resizebox{0.88\textwidth}{!}{% inlined TikZ: fig_temporal_moe_eta.tikz
...
\matrix (expertsrow) [row sep=0mm, column sep=6mm, below=12mm of router, ampersand replacement=\&] {
...
\begin{figure}[t]
    \centering
    \resizebox{\linewidth}{!}{% inlined TikZ: fig_temporal_gru_detail.tikz
