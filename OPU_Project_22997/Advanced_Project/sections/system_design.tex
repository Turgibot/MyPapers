...
The SUMO service handles traffic simulation and multi-variant dataset generation:
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Extract GPS trajectories for trajectory-based models
        \item Aggregate sensor readings for static graph models
        \item Extract route segments for route-aware models
        \item Generate synchronized multi-variant data from single simulation
    \end{itemize}
